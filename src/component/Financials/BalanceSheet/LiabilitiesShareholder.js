...
import { BalanceSheetDef } from '../defination';
      ...
      var current = [
        {
          ...
          tooltip: BalanceSheetDef.liability.current.accountsPayable,
        },
        {
          col0: name[1],
          ...
          tooltip: BalanceSheetDef.liability.current.currentLongTermDebt,
        },
        {
          col0: name[2],
          ...
          tooltip: BalanceSheetDef.liability.current.otherCurrentLiabilities,
        },
        {
          col0: name[3],
          ...
          tooltip: BalanceSheetDef.liability.current.totalCurrentLiabilities,
        },
      ];
      ...
      var nonCurrent = [
        {
          ...
          tooltip: BalanceSheetDef.liability.nonCurrent.longTermDebt,
        },
        {
          col0: nonName[1],
          ...
          tooltip: BalanceSheetDef.liability.nonCurrent.nonCurrent,
        },
        {
          col0: nonName[2],
          ...
          tooltip:
            BalanceSheetDef.liability.nonCurrent.nonCurrentLiabilitiesTotal,
        },
        {
          col0: nonName[3],
          col1: data[0]?.nonCurrentLiabilitiesTotal,
          ...
          col9: data[8]?.nonCurrentLiabilitiesTotal,
          col10: data[9]?.nonCurrentLiabilitiesTotal,
          tooltip: BalanceSheetDef.liability.nonCurrent.totalAssets,
        },
        {
          col0: nonName[4],
          ...
          tooltip: BalanceSheetDef.liability.nonCurrent.minorityInterest,
        },
        {
          col0: nonName[5],
          ...
          tooltip: BalanceSheetDef.liability.nonCurrent.shareholderEquity,
        },
        {
          col0: nonName[6],
          ...
          tooltip:
            BalanceSheetDef.liability.nonCurrent
              .liabilitiesAndShareholderEquityTotal,
        },
        {
          col0: nonName[7],
          ...
          tooltip: BalanceSheetDef.liability.nonCurrent.commonSharesOutstanding,
        },
        {
          col0: nonName[8],
          ...
          tooltip: BalanceSheetDef.liability.nonCurrent.fiscalDate,
        },
        {
          col0: nonName[9],
          ...
          tooltip: BalanceSheetDef.liability.nonCurrent.reportDate,
        },
      ];
  ...
  return (
    <>
      <h6 className='mb-4 mt-5'>
        <strong>Liabilities & Shareholder's Equity</strong>
      </h6>
        ...
        <table className='table table-bordered m-0 most_tables'>
          ...
          <tbody className='border-top-0'>
            ...
            {!Loading &&
              ...
              NonCurrentLiabilities.map((ob, i) => {
                return (
                  <tr key={i}>
                    {ob.col0 && (
                      <td>
