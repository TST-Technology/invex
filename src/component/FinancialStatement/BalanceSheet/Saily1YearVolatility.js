...
const Saily1YearVolatility = ({ data, Loading }) => {
      ...
      var SailyChartData = [
        {
          ...
          tooltip: BalanceSheetDef.currentCash,
        },
        {
          col0: name[1],
          ...
          tooltip: BalanceSheetDef.receivables,
        },
        {
          col0: name[2],
          ...
          tooltip: BalanceSheetDef.inventory,
        },
        {
          col0: name[3],
          ...
          tooltip: BalanceSheetDef.otherCurrentAssets,
        },
        {
          col0: name[4],
          ...
          tooltip: BalanceSheetDef.currentAssets,
        },
      ];
      ...
      var nonCurrent = [
        {
          ...
          tooltip: BalanceSheetDef.propertyPlantEquipment,
        },
        {
          col0: nonName[1],
          ...
          tooltip: BalanceSheetDef.intangibleAssets,
        },
        {
          col0: nonName[2],
          ...
          tooltip: BalanceSheetDef.goodwill,
        },
        {
          col0: nonName[3],
          ...
          tooltip: BalanceSheetDef.longTermInvestments,
        },
        {
          col0: nonName[4],
          ...
          tooltip: BalanceSheetDef.otherNonCurrentAssets,
        },
        {
          col0: nonName[5],
        ...
        },
        {
          ...
          tooltip: BalanceSheetDef.totalAssets,
        },
      ];
  ...
  return (
    <>
      <h6 className='mb-4'>
        <strong>AAPL: Saily 1 Year Volatility Chart</strong>
      </h6>
            ...
            <tr>
              <th scope='col'>
                ...
                <i
                  ...
                  data-toggle='tooltip'
                  title={BalanceSheetDef.currentAssets}
                ></i>
              </th>
              {data &&
                data.length > 0 &&
            ...
            <tr>
              <th scope='col'>
                ...
                <i
                  class='bi bi-info-circle m-1'
                  data-toggle='tooltip'
                  title={BalanceSheetDef.longTermInvestments}
                ></i>
              </th>
              {data &&
                data.length > 0 &&
